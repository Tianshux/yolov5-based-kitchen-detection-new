...
# 设置文件夹路径和输出文件夹路径
txt_folder = r"C:\Users\A\Desktop\VOC2007\Annotations"  # 存放LabelImg标注的txt文件的文件夹路径
output_folder = r"C:\Users\A\Desktop\VOC2007\Annotations"  # 输出LabelMe标注的json文件的文件夹路径
img_folder = r"C:\Users\A\Desktop\VOC2007\JPEGImage" #存放对应标签的图片文件夹路径
...
for filename in os.listdir(txt_folder):
    if filename.endswith('.txt'):
        ...
        if not os.path.exists(os.path.join(img_folder, image_filename)):
