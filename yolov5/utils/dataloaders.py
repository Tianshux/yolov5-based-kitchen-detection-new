...
class LoadStreams:
    ...
    def __init__(self, sources='file.streams', img_size=640, stride=32, auto=True, transforms=None, vid_stride=1, task_host='', session=None):
        ...
        while cap.isOpened() and n < f:
            ...
            if n % self.vid_stride == 0:
                ...
                if success:
                    ...
                    # msg['msg'] = '视频流异常'
                    # isValid = False
                    # response = self.session.post(self.task_host, json=msg)
